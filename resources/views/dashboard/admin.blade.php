...
<div class="mt-6 grid gap-6 xl:grid-cols-3">
    <div class="app-panel p-5 sm:p-6 xl:col-span-2"><div><h2 class="app-heading">Xu hướng chuyên cần 6 tháng gần nhất</h2><p class="app-subtitle">Số bản ghi theo trạng thái</p></div><div class="relative mt-5 h-72"><canvas id="attendance-trend-chart" aria-label="Biểu đồ xu hướng chuyên cần"></canvas></div></div>
