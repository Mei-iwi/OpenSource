...
@section('content')
<x-page-header eyebrow="Employee workspace" title="Xin chào, nhân viên" description="Xem nhanh hồ sơ và lịch sử chấm công cá nhân của bạn."><a href="#profile" class="rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700">Hồ sơ của tôi</a></x-page-header>
