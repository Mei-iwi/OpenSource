...
<head>
    ...
    <title>HR Management — Hệ thống quản trị nhân sự và chấm công</title>
...
<body class="bg-slate-950 text-slate-100 selection:bg-indigo-500 selection:text-white antialiased">
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-slate-950/75 backdrop-blur-xl">
        <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
            <a href="/" class="flex items-center gap-3">
                ...
                <div>
                    <span class="text-xl font-extrabold tracking-tight text-white">HR Management</span>
                </div>
            </a>
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-500/30 transition hover:from-indigo-600 hover:to-indigo-700">
                ...
                @else
                    ...
                    @endif
                    <a href="{{ route('login') }}" class="inline-flex items-center rounded-xl bg-gradient-to-r from-indigo-500 via-indigo-600 to-sky-500 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-500/30 transition hover:shadow-indigo-500/50">
                        <span>Đăng nhập</span>
                    </a>
                @endauth
            </div>
    ...
    <main class="relative z-10">
        <section class="mx-auto max-w-7xl px-6 pt-16 pb-24 text-center lg:px-8 lg:pt-24">
            <!-- Badge -->
            <div class="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 text-xs font-semibold text-indigo-300">
            ...
            <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('login') }}" class="inline-flex items-center rounded-2xl bg-indigo-600 px-7 py-3.5 text-base font-bold text-white shadow-xl shadow-indigo-600/30 transition hover:bg-indigo-500 hover:shadow-indigo-500/50">
                    <span>Trải nghiệm ngay</span>
                </a>
                <a href="#features" class="inline-flex items-center rounded-2xl border border-white/15 bg-white/5 px-6 py-3.5 text-base font-semibold text-slate-200 transition hover:bg-white/10 hover:border-white/30">
                    <span>Khám phá tính năng</span>
                </a>
            </div>

            <!-- Product Showcase / Interactive Mockup Preview -->
            <div class="mt-16 rounded-3xl border border-white/15 bg-slate-900/80 p-3 sm:p-5 shadow-xl ring-1 ring-white/10">
                <div class="rounded-2xl border border-white/10 bg-slate-950 p-6 sm:p-8 text-left">
                    ...
                    <div class="flex items-center justify-between border-b border-white/10 pb-5">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="ml-3 text-xs font-mono text-slate-400">dashboard.hrm.internal</span>
                        </div>
        ...
        <section id="features" class="border-t border-white/10 bg-slate-900/30 py-24">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <!-- Feature 1 -->
                    <div class="group rounded-3xl border border-white/10 bg-slate-900/80 p-8 transition hover:border-indigo-500/50 hover:bg-slate-900/90">
                        ...
                        <h3 class="text-lg font-bold text-white">Chấm công bằng Camera</h3>
        ...
        <section class="border-t border-white/10 py-24 bg-gradient-to-b from-slate-900/50 to-slate-950 text-center">
            <div class="mx-auto max-w-3xl px-6 lg:px-8">
                ...
                <p class="mt-4 text-slate-400 text-base sm:text-lg">Đăng nhập vào hệ thống quản lý nhân sự để quản lý đội ngũ hiệu quả và tinh gọn.</p>
                <div class="mt-8">
                    <a href="{{ route('login') }}" class="inline-flex items-center rounded-2xl bg-indigo-600 px-8 py-4 text-base font-bold text-white shadow-xl shadow-indigo-600/30 transition hover:bg-indigo-500">
